...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/rgrouls/Dropbox/KI/ICW/werkgroep/code/CWI/movingDots.psyexp',
...
image = visual.ImageStim(
    ...
    image=u'gist/vrouw2.jpg', mask=None,
    ori=0, pos=(10, 0), size=(2, 2),
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    # *image* updates
    if t >= 2.0 and image.status == NOT_STARTED:
        # keep track of start time/frame for later
        image.tStart = t
        image.frameNStart = frameN  # exact frame index
        image.setAutoDraw(True)
    frameRemains = 2.0 + 0.1- win.monitorFramePeriod * 0.75  # most of one frame period left
