...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/rgrouls/Dropbox/KI/ICW/werkgroep/code/CWI/Demo.psyexp',
...
instrText = visual.TextStim(win=win, name='instrText',
    text='Remember, choose the colour of the letters, ignore the word:\n\nleft = red\ndown = green\nright = blue',
    font='Arial',
...
instructionsComponents = [instrText, key_resp_3]
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    trialComponents = [target, key_resp_2]
